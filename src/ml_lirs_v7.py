"""
model: naive bayes sklearn.naive_bayes.MultinomialNB
...
class WriteToFile:
    def __init__(self, tName, st):
        ...
        try:  
            ...
            print(error)
        self.FILE = open("../result_set/" + self.tName + "/ml_lirs_v7_" + str(st) + "_" + self.tName, "w")
...
class Segment_Miss:
    def __init__(self, tName, cache):
        self.tName = tName
        self.FILE = open("../result_set/" + self.tName + "/ml_lirs_v7_" + self.tName + "_" +str(cache) + "_segment_miss", "w")
